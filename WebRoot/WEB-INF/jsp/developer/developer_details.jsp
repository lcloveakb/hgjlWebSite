...
<script type="text/javascript" src="lib/js/comment.js"></script>
  ...
  <body>
	...
	<input type="hidden" value="${item.parentId }" id="articleId">
    <div class="wrapper">        
    	<!-- header -->
            ...
            <div class="container row">
                <section class="content item">
					...
					<div class="article-l clearfix">
						<div class="posts left" style="margin-right: 50px;">
							<article class="post">
								...
								<section class="entry-info">
									<div class="info" style="font-size: 12px;color: #ADADAD;font-style: italic;">
										SenseMaker&nbsp;&nbsp;发布于&nbsp;&nbsp;<span class="date" style="margin-left: 20px;"> <fmt:formatDate
												value="${item.createTime }" type="both"
												pattern="yyyy-MM-dd" />
										</span>
									</div>
								</section>
								<section class="entry-content">${item.content }</section>
								<div class="share">
									<h3>分享至</h3>
						...
						<div class="module">
							...
							<ul class="bar-list">
								<c:forEach items="${lately }" var="l">
									<li><a
										href="search/searchAction_itemSearch.action?type=1&id=${l.articleId }">${l.title }</a> 
									</li>
								</c:forEach>
							</ul>
						</div>
						<div class="module">
							...
							<ul class="bar-list">
								<c:forEach items="${hot }" var="h">
									<li><a
										href="search/searchAction_itemSearch.action?type=1&id=${h.articleId }">${h.title }</a> 
									</li>
								</c:forEach>
							</ul>
						</div>
